...
/* functions */
/*============================================================ */
static void Init_ODM_ComInfo_8188gtv(PADAPTER	Adapter)
{
	PHAL_DATA_TYPE	pHalData = GET_HAL_DATA(Adapter);
...
void rtl8188gtv_init_dm_priv(PADAPTER Adapter)
{
	PHAL_DATA_TYPE	pHalData = GET_HAL_DATA(Adapter);
	struct dm_struct		*podmpriv = &pHalData->odmpriv;
	Init_ODM_ComInfo_8188gtv(Adapter);
	odm_init_all_timers(podmpriv);

}

void rtl8188gtv_deinit_dm_priv(PADAPTER Adapter)
{
	PHAL_DATA_TYPE	pHalData = GET_HAL_DATA(Adapter);
	struct dm_struct		*podmpriv = &pHalData->odmpriv;
