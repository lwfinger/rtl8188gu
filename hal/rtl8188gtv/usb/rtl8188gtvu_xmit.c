...
#define _RTL8188GTVU_XMIT_C_

#include <rtl8188gtv_hal.h>


s32	rtl8188gtvu_init_xmit_priv(_adapter *padapter)
{
	struct xmit_priv	*pxmitpriv = &padapter->xmitpriv;

#ifdef PLATFORM_LINUX
	tasklet_init(&pxmitpriv->xmit_tasklet,
		     (void(*)(unsigned long))rtl8188gtvu_xmit_tasklet,
		     (unsigned long)padapter);
#endif
	return _SUCCESS;
}

void	rtl8188gtvu_free_xmit_priv(_adapter *padapter)
{
}
...
static s32 update_txdesc(struct xmit_frame *pxmitframe, u8 *pmem, s32 sz, u8 bagg_pkt)
{
	...
	rtl8188gtv_update_txdesc(pxmitframe, (u8 *)ptxdesc);
...
static s32 rtw_dump_xframe(_adapter *padapter, struct xmit_frame *pxmitframe)
{
	...
	for (t = 0; t < pattrib->nr_frags; t++) {
		...
		/*		rtl8188gtv_update_txdesc(pxmitframe, mem_addr+PACKET_OFFSET_SZ); */
...
s32 rtl8188gtvu_mgnt_xmit(_adapter *padapter, struct xmit_frame *pmgntframe)
{
 ...
 */
s32 rtl8188gtvu_hal_xmit(_adapter *padapter, struct xmit_frame *pxmitframe)
{
...
static void rtl8188gtvu_hostap_mgnt_xmit_cb(struct urb *urb)
{
#ifdef PLATFORM_LINUX
...
s32 rtl8188gtvu_hostap_mgnt_xmit_entry(_adapter *padapter, _pkt *pkt)
{
#ifdef PLATFORM_LINUX
	u16 fc;
	int rc, len, pipe;
